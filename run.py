...
predicate_list, predicate_list_minus = process.generate_tup_predicate(dataset_list, dict_predicate, all_predicate_set)
R_CFDs = process.generate_R_CFDs(dataset_list, dict_predicate, predicate_list, predicate_list_minus, all_predicate_set)
